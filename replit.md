...
- **Turnaround** (`turnaround.tsx`, `/turnaround`) — 8-state deep-dive: TurnaroundWarnings + per-activity ageing-vs-target + contractor overrun + urgency worklist (by daysToTarget) + the AI turnaround report (`components/ai-turnaround-report.tsx`).
